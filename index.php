    ...
    <div class="container bg-grey" id="contact">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <p><span class="glyphicon glyphicon-phone"></span> +254718332748</p>
...
<!-- Add Google Maps -->
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCtD0gaxHYMxV1hO046gAguj-NclIYG1ws"></script>

<script>
    var myCenter = new google.maps.LatLng(-1.281698,36.815049);
